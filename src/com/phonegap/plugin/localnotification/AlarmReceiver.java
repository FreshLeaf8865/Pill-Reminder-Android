...
import com.medidoz.medidoz_english.MyPhoneGapActivity;
import com.medidoz.medidoz_english.R;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		Log.i("AlarmReceiver", "AlarmReceiver invoked!");
		...
		{
			Log.i("AlarmReceiver", "Unable to process alarm with id: " + bundle.getString(NOTIFICATION_ID));
		}
		...
		if (currentHour != alarmHour && currentMin != alarmMin) {
			 ...
			 */
			Log.i(LocalNotification.PLUGIN_NAME, "AlarmReceiver, ignoring alarm since it is due");
			return;
		}
		

		String tmpSoundOption = PreferenceManager.getDefaultSharedPreferences(context).getString("soundOption", "on");
		String tmpVibrationOption = PreferenceManager.getDefaultSharedPreferences(context).getString("vibrationOption", "on");
		//String tmpLightsOption = PreferenceManager.getDefaultSharedPreferences(context).getString("lightsOption", "on");
		
		Log.i("****** tmpSoundOption: ", tmpSoundOption);
		Log.i("****** tmpVibrationOption: ", tmpVibrationOption);
		//Log.i("****** tmpLightsOption: ", tmpLightsOption);
		...
		if (tmpSoundOption.equalsIgnoreCase("on"))
		{
			isSoundOn = true;
		}
		else
		...
		if (tmpVibrationOption.equalsIgnoreCase("on"))
		{
			isVibrationOn = true;
		}
		else
...
//		if (tmpLightsOption.equalsIgnoreCase("on"))
//		{
//			isLightsOn = true;
//		}
//		else
...
//		}
		...
		Log.i("****** isSoundOn: ", String.valueOf(isSoundOn));
		Log.i("****** isVibrationOn: ", String.valueOf(isVibrationOn));
		//Log.i("****** isLightsOn: ", String.valueOf(isLightsOn));
		
//		Intent i = new Intent(context, MyAlarmResponse.class);
...
//	    context.startActivity(i);
		...
		final Notification notification = new Notification(R.drawable.logo, tickerText,
